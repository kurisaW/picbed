...
def send_email(github_token, recipient, file_count):  
    ...
    try: 
        ...
        server.sendmail('githubaction@gmail.com', recipient.encode('ascii'), message.as_string().encode('ascii'))
        server.quit() 
...
if file_count > file_limit:  
    ...
    default_email = default_email.encode('ascii', 'ignore').decode('ascii')
